...
\newcommand{\presentationEntry}[6]{
  \begin{blockIndent}{}
    \ifthenelse{
      \equal{#6} {}}
      {\textsc{#1}} {\href{#6}{\textsc{#1}}} \hfill #3 \\
    Event: #2 \hfill #4 \\
    Summary: #5 \\
  \end{blockIndent}
}
...
%
\newcommand{\organizationInvolvementEntry}[3]{
  \begin{blockIndent}{}
    \ifthenelse{
      \equal{#3} {}}
      {\textsc{#1}} {\href{#3}{\textsc{#1}}} \\
    Role: #2 \\
  \end{blockIndent}
}
...
\begin{document}
  ...
  \academicAwardsEntry
    ...
    {Sep. 2008}
    {Apr. 2011}
    {For attaining a semester GPA of at least 3.80/4.30 during a undergradate degree.}
  ...
  \presentationEntry
    ...
    {Jun. 2011}
    {Detailed and demostrated an Eclipse plugin for testing multi--threaded Java programs}
