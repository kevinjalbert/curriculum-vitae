...
\begin{document}
  ...
  \generalEntry{
    To acquire a position that utilizes my strong software engineering background and computer science skill set. My ideal position would involve work that is challenging, innovative and exciting. The ability to contribute to open-source software is enticing and beneficial to personal/professional growth.
  }
  ...
  \generalEntry{
    \begin{itemize}[noitemsep,nolistsep]
 			\item Eagerness and excitement to improve and optimize product and services.
    	\item Excellent academic record with numerous honors and awards.
			\item Strong technical writing ability and able to present concise technical material.
			\item Dedication to the field demonstrated through open source and community involvement.
    \end{itemize}
  }
